...
Система импортирует планы производства из Excel, сканирует папки с протоколами (.docx) и извлекает интервалы простоев производственных линий с использованием локального LLM (Qwen 2.5). Обнаруживает конфликты между плановыми задачами и простоями, визуализирует данные в интерактивном интерфейсе.
